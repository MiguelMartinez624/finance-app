...
export interface InitOutput {
  ...
  readonly closure734_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure738_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1060_externref_shim: (a: number, b: number, c: any) => void;
