...
export interface InitOutput {
  ...
  readonly closure2839_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure2845_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure3164_externref_shim: (a: number, b: number, c: any) => void;
